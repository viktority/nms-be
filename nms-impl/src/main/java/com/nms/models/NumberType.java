...
public class NumberType {
    ...
    @Valid
    private List<ApprovalStage> listOfApprovalStages = null;
    ...
    public NumberType listOfApprovalStages(List<ApprovalStage> listOfApprovalStages) {
        this.listOfApprovalStages = listOfApprovalStages;
        return this;
    }

    public NumberType addListOfApprovalStagesItem(ApprovalStage listOfApprovalStageItem) {
        if (this.listOfApprovalStages == null) {
            this.listOfApprovalStages = new ArrayList<ApprovalStage>();
        }
        this.listOfApprovalStages.add(listOfApprovalStageItem);
        return this;
    }
    ...
    @Schema(description = "")
    @Valid
    public List<ApprovalStage> getListOfApprovalStages() {
        return listOfApprovalStages;
    }

    public void setListOfApprovalStages(List<ApprovalStage> listOfApprovalStages) {
        this.listOfApprovalStages = listOfApprovalStages;
    }
